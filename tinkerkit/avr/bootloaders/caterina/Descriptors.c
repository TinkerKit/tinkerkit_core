...
const USB_Descriptor_String_t ProductString =
{
	...
	#if DEVICE_PID == 0x0010
	.UnicodeString          	= L"TinkerKit LCD   " 
	#elif DEVICE_PID == 0x0011
	.UnicodeString			= L"TK DMX Rec. MOS "
	#elif DEVICE_PID == 0x0012
	.UnicodeString			= L"TK DMX Rec.RELAY"
	#else
...
const USB_Descriptor_String_t ManufNameString = 
{
	...
	#if DEVICE_VID == 0x27CD
	.UnicodeString			= L"TinkerKit  "
	#else
